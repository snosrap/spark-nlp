...
import com.johnsnowlabs.ml.tensorflow.{ClassifierDatasetEncoder, ClassifierDatasetEncoderParams, ReadTensorflowModel, TFWrapper, TensorflowMultiClassifier, TensorflowWrapper, WriteTensorflowModel}
