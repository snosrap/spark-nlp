...
````
4. You need to create /lib folder and paste the park-nlp-jsl-${version}.jar file.
 
5. Add the fat spark-nlp-healthcare in your classpath.You can do it adding this line in your build.sbt
