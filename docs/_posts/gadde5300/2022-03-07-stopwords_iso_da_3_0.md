---
layout: model
title: Stopwords Remover for Danish language (stopwords-iso)
author: John Snow Labs
name: stopwords_iso
date: 2022-03-07
tags: [stopwords, da, open_source]
task: Lemmatization
language: da
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_da_3.4.1_3.0_1646665622509.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
stop_words = StopWordsCleaner.pretrained("stopwords_iso","da") \
    .setInputCols(["token"]) \
...
val lemmatizer = StopWordsCleaner.pretrained("stopwords_iso","da") 
