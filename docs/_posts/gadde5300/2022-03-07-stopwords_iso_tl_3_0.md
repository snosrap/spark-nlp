---
layout: model
title: Stopwords Remover for Tagalog language (stopwords-iso)
author: John Snow Labs
name: stopwords_iso
date: 2022-03-07
tags: [stopwords, tl, open_source]
task: Lemmatization
language: tl
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_tl_3.4.1_3.0_1646665636178.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
stop_words = StopWordsCleaner.pretrained("stopwords_iso","tl") \
    .setInputCols(["token"]) \
...
val lemmatizer = StopWordsCleaner.pretrained("stopwords_iso","tl") 
