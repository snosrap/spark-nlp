---
layout: model
title: Stopwords Remover for Italian language (stopwords-iso)
author: John Snow Labs
name: stopwords_iso
date: 2022-03-07
tags: [stopwords, it, open_source]
task: Lemmatization
language: it
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_it_3.4.1_3.0_1646665627635.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
stop_words = StopWordsCleaner.pretrained("stopwords_iso","it") \
    .setInputCols(["token"]) \
...
val lemmatizer = StopWordsCleaner.pretrained("stopwords_iso","it") 
