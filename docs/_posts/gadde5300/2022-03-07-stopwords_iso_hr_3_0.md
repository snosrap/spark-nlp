---
layout: model
title: Stopwords Remover for Croatian language (stopwords-iso)
author: John Snow Labs
name: stopwords_iso
date: 2022-03-07
tags: [stopwords, hr, open_source]
task: Lemmatization
language: hr
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_hr_3.4.1_3.0_1646665683774.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
stop_words = StopWordsCleaner.pretrained("stopwords_iso","hr") \
    .setInputCols(["token"]) \
...
val lemmatizer = StopWordsCleaner.pretrained("stopwords_iso","hr") 
